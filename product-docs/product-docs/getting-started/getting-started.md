...
{% hint style="info" %}
If you're evaluating the platform for your team rather than yourself, jump to [Core concepts](https://app.gitbook.com/s/6AWQQD2xKbjzfq5Hrg7o/core-concepts "mention") first — it'll save time when you set things up properly.
{% endhint %}
